...
def login():
    ...
    time.sleep(0.05)
    print "\033[1;95m[2]>>>\x1b[1;93mSOMI WHATAAP CONTACT NUMBER"
    time.sleep(0.05)
...
def Zeek():
    ...
    time.sleep(0.10)
    print '\x1b[1;91m[2>>>] SOMI FACEBOOK'
    time.sleep(0.10)
...
def action():
    ...
    if peak =='':
        ...
        print'\033[1;93m░█▄▄█ 　 ░█▄▄█ 　 ░█▀▄─  '
        print'\033[1;94m░█─── 　 ░█─░█ 　 ░█─░█'
        print'\033[1;91m MA ADMI KOI AMM NI ONE MAN ARMY'
        print "\033[1;96mEnter any Pakistani Mobile code Number"+'\n'
        print 'Enter any code 033[1;93m 1----to----49 '
        try:
    ...
    print 50* '\033[1;97m-'
    xxx = str(len(id))
    jalan ('[✔]\033[1;96m Total indian ids: '+xxx)
